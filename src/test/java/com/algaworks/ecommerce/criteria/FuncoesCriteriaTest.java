...
public class FuncoesCriteriaTest extends EntityManagerTest {
    ...
    public void aplicarFuncoesNativas() {
        ...
        criteriaQuery.where(criteriaBuilder.isTrue(criteriaBuilder
                .function("acima_media_faturamento", Boolean.class, root.get(Pedido_.total))));
    ...
    public void aplicarFuncaoColecao() {
        ...
        criteriaQuery.groupBy(root.get(Pedido_.id));
